...
import { loadModels, createAvatarModel } from './tools/glbLoader.js'; // Add createAvatarModel import
...
(async () => {
    try {
        const models = await loadModels(scene, faceColor); // Pass colors to loadModels
